...
Remote LAN	Branch Office LAN	192.168.40.0/24	192.168.40.1
Technologies Used
Cisco Packet Tracer
Cisco IOS
...
Router1	10.0.12.0, 192.168.10.0, 192.168.100.0
Router2	10.0.12.0, 10.0.23.0
Router3	10.0.23.0, 10.0.34.0
...
VLAN10 PC → VLAN20 PC
VLAN30 PC → Remote Branch PC
Wireless Device → Remote LAN
Remote LAN → DHCP Server
Expected Results

After successful configuration:

All devices receive IP addresses dynamically
Inter-VLAN communication functions correctly
OSPF exchanges routes dynamically
Remote branch LAN communicates with headquarters VLANs
...
Load the .pkt project file
Wait for all interfaces to become active
Verify DHCP assignment on all devices
Test connectivity using ping
Use verification commands for troubleshooting
Author
...
Networking practice
Cisco CCNA/CCNP lab simulations
